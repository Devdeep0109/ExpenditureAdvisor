    ...
    <header>
        ...
        <div class="flex">
            <div class="flex-child">
                <h1>Devdeep</h1><br>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit doloremque earum sit animi id et qui
                    esse
                    laborum numquam cumque, laudantium officiis veniam eius. Exercitationem aut maxime ipsum itaque
                    animi
