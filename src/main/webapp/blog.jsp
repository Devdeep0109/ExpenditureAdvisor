...
<div class="top-banner">
    ...
    <div class="flex">
        <div class="flex-child">
            <h1>Expenditure</h1><br>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit doloremque earum sit animi id et qui esse
                laborum numquam cumque, laudantium officiis veniam eius. Exercitationem aut maxime ipsum itaque animi
                incidunt saepe obcaecati suscipit aliquid reiciendis, officia quibusdam architecto repudiandae!</p>
        </div>
        <div class="flex-child">
            <h1>Needs</h1><br>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit doloremque earum sit animi id et qui esse
